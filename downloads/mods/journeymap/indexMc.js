journeymap();
function journeymap(){   
fetch("https://www.curseforge.com/api/v1/mods/32274/files")
.then(response => response.json())
.then(data => {
     let journeymap = data.data;

     journeymap.forEach(file => {
    ...
    document.querySelector('#js-postModsJv-jm').innerHTML += `
    <div class="mods-container tooltip-container">
        <div class="img">
        <img src="https://media.forgecdn.net/avatars/9/144/635421614078544069.png" alt="">
        </div>
